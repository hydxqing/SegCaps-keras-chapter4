...
RESOLUTION = 320  # Resolution of the input for the model.
GRAYSCALE = False
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', type=str, default='/media/data1/wang/SegCaps-master/data/',
                        help='The root directory for your data.')
    parser.add_argument('--data_root_dir', type=str, default='./media/data',
                        help='The root directory for your data.')
    ...
    parser.add_argument('--loss', type=str.lower, default='bce', choices=['bce', 'w_bce', 'dice', 'bce_dice', 'mar', 'w_mar'],
